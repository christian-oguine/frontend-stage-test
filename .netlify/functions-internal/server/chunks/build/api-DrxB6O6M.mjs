...
import { u as useAsyncData } from './index-BSswy0dG.mjs';
...
const API_BASE_URL = "https://akabab.github.io/starwars-api/api";
const API_ENDPOINTS = {
  allCharacters: `${API_BASE_URL}/all.json`,
  characterById: (id) => `${API_BASE_URL}/id/${id}.json`
};

export { API_ENDPOINTS as A, useFetch as u };
//# sourceMappingURL=api-DrxB6O6M.mjs.map
