...
import { b as buildAssetsURL, a as useRuntimeConfig, c as getResponseStatusText, d as getResponseStatus, e as defineRenderHandler, p as publicAssetsURL, f as getQuery, h as createError, i as destr, k as getRouteRules, r as relative, l as joinURL, u as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"A Star Wars characters management application built with Nuxt and Pinia."}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"Star Wars Characters App"};
...
const entryFileName = "crxAhjKb.js";
